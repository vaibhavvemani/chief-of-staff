...
function ContentView({ workspace, canReview, canRevise, canContentRepair, canRepair, repairUnavailableReason, repairBusy, onContentAction, onRepairDecision, onRepairRoute, onContentRepair }: { workspace: Workspace; canReview: boolean; canRevise: boolean; canContentRepair: boolean; canRepair: boolean; repairUnavailableReason?: string; repairBusy: boolean; onContentAction?: (action: string, asset: ContentAsset, claim?: Claim) => void; onRepairDecision?: (entry: SourceRepairEntry, candidateId: string) => void; onRepairRoute?: (entry: SourceRepairEntry) => void; onContentRepair?: (entry: SourceRepairEntry) => void }) {
  ...
  const initial = assets.find((asset) => attentionTotalForAsset(asset.id) > 0) ?? assets[0];
