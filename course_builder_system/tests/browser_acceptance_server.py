...
from acceptance import NEXT_CYCLE_ACCEPTANCE_COURSE_ID
...
_seed_root = _acceptance_root / "courses" / NEXT_CYCLE_ACCEPTANCE_COURSE_ID
...
for _fixture_path in _fixture_root.glob("*.json"):
    ...
    _artifact["course_id"] = NEXT_CYCLE_ACCEPTANCE_COURSE_ID
