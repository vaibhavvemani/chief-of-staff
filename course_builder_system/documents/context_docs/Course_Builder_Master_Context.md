...
- **Immediate next action:** resolve NC-003 using its documented fallback subject, then begin NC-90 in dependency order. NC-40 remains incomplete, and NC-406 remains deferred to NC-90 and unstarted; NC-504, NC-604, and NC-303 stay deferred behind NC-905, NC-908, and NC-902 respectively. Do not skip their live-parity dependencies.
