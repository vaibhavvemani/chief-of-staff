...
- **Current state:** The four-week pipeline prototype and the local Course Builder Studio frontend are implemented and independently reviewed through NC-302 and NC-404. NC-401 through NC-404 provide independently verified deterministic Course Model backend contracts and typed browser editing; NC-40 remains incomplete. The reusable contracts, prompts, context builder, verification, integrity path, FastAPI adapter, React workspace, durable guided intake, Outcomes and Course Model editors, local acceptance course, live-run evidence, and FRM benchmark are in place. FRM-specific fixtures remain benchmark data, not reusable prompt or contract assumptions.
...
- **Immediate next action:** begin NC-405's detailed Course Model diff summary. NC-405 and NC-406 remain unstarted at this checkpoint; do not begin NC-406 live revision before its dependencies. NC-303 stays deferred to NC-90 behind NC-902. Do not skip ahead to source repair or live-agent parity.
