...
- **Immediate next action:** begin NC-404 Course Model edit UI work against the independently verified NC-401 through NC-403 backend contract while preserving the verified NC-10 lifecycle, NC-20 intake, and NC-30 Outcomes contracts. NC-405 remains dependent on completion of NC-404. NC-404 through NC-406 and all later packages remain unstarted at this checkpoint; NC-303 stays deferred to NC-90 behind NC-902. Do not skip ahead to source repair or live-agent parity.
