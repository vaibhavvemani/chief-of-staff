...
- **Current state:** The four-week pipeline prototype and the local Course Builder Studio frontend are implemented and independently reviewed through NC-302, NC-405, and NC-503. NC-401 through NC-405 provide independently verified deterministic Course Model backend contracts, typed browser editing, and exact-preview structural diffs; NC-501 through NC-503 provide the corresponding typed Blueprint defaults/exceptions, reconciliation, lifecycle/source gates, and browser Scenario A7. NC-40 remains incomplete because NC-406 is deferred to NC-90, and NC-504 is likewise deferred behind NC-905. The reusable contracts, prompts, context builder, verification, integrity path, FastAPI adapter, React workspace, durable guided intake, Outcomes/Course Model/Blueprint editors and diffs, local acceptance course, live-run evidence, and FRM benchmark are in place. FRM-specific fixtures remain benchmark data, not reusable prompt or contract assumptions.
...
- **Immediate next action:** implement NC-601 through NC-603 as the deterministic NC-60 Lesson Plan decisions checkpoint and keep NC-604 deferred. NC-40 remains incomplete, and NC-406 remains deferred to NC-90 and unstarted; NC-504 also stays deferred behind NC-905, and NC-303 stays deferred behind NC-902. Do not skip ahead to source repair or live-agent parity.
